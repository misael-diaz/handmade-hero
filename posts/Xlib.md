...
- UPDATE SRC WITH XDESTROYSUBWINDOWS FOR COMPLETENESS (BETTER THAN XDESTROYWINDOW)
  PART OF THE RESEARCH IS TO DIVE TO THE XSERVER CODE TO SEE THE CREATE/DESTROY CODE
- FIND OUT BY LOOKING AT THE XSERVER CODE IF THE WINDOW PROPERTIES ARE DESTROYED WHEN
  CALLING XDESTROYSUBWINDOWS
